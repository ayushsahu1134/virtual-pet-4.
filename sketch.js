...
function setup() {
  ...
  feed.position(900,125);
  feed.mousePressed(feedDog);

  addFood=createButton("Add Food");
  addFood.position(1030,125);
  ...
  milkBotltle2 = createSprite(-5,280,10,10);
